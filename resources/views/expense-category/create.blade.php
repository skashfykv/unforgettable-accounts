                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Expense Category Form</h3>
                        </div>
                        {!! Form::open(array('route'=>'expense-category.store','class'=>'form-horizontal','id'=>'season_form')) !!}
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <label for="inputEmail3" class="">Enter Expense Category Name</label>
