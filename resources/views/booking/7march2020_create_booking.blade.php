                     ...
                     <div class="col-sm-3 fb_depend">
                      ...
                      <div class="col-sm-3" style="margin-bottom:15px">
                        <label class="">Select Airline </label><span style="color:red"> * </span>
                         <select class="form-control select2" name="fb_airline_name_id" required="required">
                      ...
                      <div class="col-sm-3" style="margin-bottom:15px">
                        <label class="">Select Payment</label><span style="color:red"> * </span>
                          <select class="form-control select2" name="fb_payment_method_id" required="required">
                      ...
                      <div class="col-sm-4" style="margin-bottom:15px">
                        ...
                        <div class="input-group">
                           <span class="input-group-addon"></span>
                           {!! Form::text('fb_booking_date',null,['autocomplete' => 'off','class'=>'form-control','id'=>'datepicker14','placeholder'=>'Booking Date','required'=>'true']) !!}
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="alert-danger" style="text-align:center">{{$errors->first('document_prepare')}}</div>
                       ...
                       <div class="col-sm-5 tdp_current_date">
                          ...
                          <div class="input-group">
                             <span class="input-group-addon"></span>
                             {!! Form::text('tdp_current_date',null,['autocomplete' => 'off','class'=>'form-control','id'=>'datepicker18','placeholder'=>'Travel Document Prepared Date','required' => 'true']) !!}
                          </div>
