            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        {!! Form::open(array('route'=>'user.store','class'=>'form-horizontal','id'=>'user_form')) !!}
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('name',null,['class'=>'form-control', 'id'=>'name','placeholder'=>'','required'=>'true']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::email('email',null,['class'=>'form-control','id'=>'email','placeholder'=>'','required'=>'true']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="alert-danger" style="text-align:center">{{$errors->first('confirm_password')}}</div>
                                    <label for="confirm_password" class="">Confirm Password</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock" aria-hidden="true"></i></span>
                                        {!! Form::password('confirm_password', ['class' => 'form-control','id' => 'confirm_password','required'=>'true']); !!}
                                    </div>
                                </div>
                            </div>
                        </div>
